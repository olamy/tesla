...
%MAVEN_JAVA_EXE% %MAVEN_OPTS% -classpath %CLASSWORLDS_JAR% "-Dclassworlds.conf=%M2_HOME%\bin\mvnsh.conf" "-Dmaven.home=%M2_HOME%" "-Dshell.home=%M2_HOME%" -Dshell.program=mvnsh -Dshell.version=4.0 %CLASSWORLDS_LAUNCHER% %MAVEN_CMD_LINE_ARGS%
