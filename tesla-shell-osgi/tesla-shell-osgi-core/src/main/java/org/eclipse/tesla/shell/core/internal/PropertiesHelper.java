 ...
 **********************************************************************************************************************/
package org.eclipse.tesla.shell.core.internal;
...
public class PropertiesHelper
{
    ...
    public static Properties loadPropertiesFile( File baseFolder, String fileName, boolean failIfNotFound )
        throws Exception
    {
    ...
    protected static Properties loadPropertiesUrl( URL configPropURL, boolean failIfNotFound )
        throws Exception
    {
    ...
    public static String SHA1( final Properties properties )
        throws NoSuchAlgorithmException
    {
        final MessageDigest md = MessageDigest.getInstance( "SHA-1" );

        final Set<String> keys = new TreeSet<String>( (Set) properties.keySet() );
