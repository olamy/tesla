...
/**
 * Handles the selection of mirrors for repositories. Default implementation can be extended externally via components
 * registered under MirrorSelectorDelegate interface.
 * 
